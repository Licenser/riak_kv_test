...
replication([AFirst|_] = ANodes, [BFirst|_] = BNodes, Connected) ->
    ...
    case Connected of
        false ->
            ...
            Res2 = rt_kv:systest_read(BFirst, 1, 100, TestBucket, 2),
    ...
    Res10 = rt_kv:systest_read(BSecond, 1, 100, RealtimeOnly, 2),
    ...
    Res12 = rt_kv:systest_read(BSecond, 1, 100, RealtimeOnly, 2),
    ?assertEqual(100, length(Res12)),

    lager:info("Check {repl, false} bucket didn't replicate"),
    Res13 = rt_kv:systest_read(BSecond, 1, 100, NoRepl, 2),
...
pb_write_during_shutdown(Target, BSecond, TestBucket) ->
    ...
    ReadErrors = rt_kv:systest_read(BSecond, 1000, 11000, TestBucket, 2),
    ...
    rt:wait_until_pingable(Target),
    rt:wait_for_service(Target, riak_repl),
    ReadErrors2 = rt_kv:systest_read(Target, 1000, 11000, TestBucket, 2),
